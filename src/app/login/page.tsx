        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3">
              <button
                onClick={() => !loading && signInWithProvider('google')}
                disabled={loading}
                className="flex items-center justify-center gap-2 w-full py-2 rounded border-2 border-[var(--color-gold)] hover:bg-[var(--color-gold)]/10 transition text-[var(--color-on-surface-opposite)] disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                onClick={() => !loading && signInWithProvider('facebook')}
                disabled={loading}
                className="flex items-center justify-center gap-2 w-full py-2 rounded border-2 border-[var(--color-gold)] hover:bg-[var(--color-gold)]/10 transition text-[var(--color-on-surface-opposite)] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg viewBox="0 0 24 24" width={20} height={20} aria-hidden="true" fill="currentColor">
