...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-gray-800 text-white p-4 shadow-lg z-[1000] border-t-2 border-accent" style={{ pointerEvents: 'auto', position: 'fixed' }}>
